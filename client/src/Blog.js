...
class Blog extends React.Component{
	...
	async getPost(){
        await axios.get("http://localhost:5000/api/posts/" + this.getUsername() + "/" + this.state.deleteNum)
        .then((response) => {
	...
	async updatePost(){
        ...
        await axios.put("http://localhost:5000/api/posts/" + this.getUsername() + "/" + this.state.deleteNum, data)
          .then(function (response) {
            console.log(response);
          })
          .catch(function (error) {
